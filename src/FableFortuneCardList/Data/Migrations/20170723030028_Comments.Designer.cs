...
namespace FableFortuneCardList.Data.Migrations
{
    ...
    [Migration("20170723030028_Comments")]
    partial class Comments
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FableFortuneCardList.Models.Comment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FableFortuneCardList.Models.CommentThread", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FableFortuneCardList.Models.Comment", b =>
                {
                    ...
                    b.HasOne("FableFortuneCardList.Models.Comment", "RepliedTo")
                        .WithMany("Replies")
                        .HasForeignKey("RepliedToID");

                    b.HasOne("FableFortuneCardList.Models.CommentThread", "Thread")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FableFortuneCardList.Models.ApplicationUser")
                        .WithMany("Claims")
